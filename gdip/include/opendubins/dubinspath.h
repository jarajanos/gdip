...
namespace opendubins {
    ...
    class DubinsPath : public Path<State> {
    public:
        ...
        StateAtDistance<State> getClosestStateAndDistance(const Point &p) const;
        StateAtDistance<State> intersectionPoint(Line line) const;
