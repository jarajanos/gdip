...
namespace opendubins {
    ...
    class Dubins : public Path<State> {
    ...
    public:
        ...
        virtual StateAtDistance<State> getClosestStateAndDistance(const Point &p) const;
        ...
        StateAtDistance<State> intersectLine(const Line &line) const;

        StateAtDistance<State> intersectCircle(const Circle &circle) const;
